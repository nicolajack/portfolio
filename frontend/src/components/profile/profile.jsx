...
import ProfileIcon2 from '../../assets/updateHeadshot.png'
...
function Profile() {
    return (
        <div id="profile" className="fadeInUp-animation">
            <div><img id="profilepic" width ="350" src={ProfileIcon2} /></div>
            <div id="profile-text">
                <p>hello, i am</p>
                <h2><i>n</i>ico jackso<i>n</i></h2>
                <p>junior @ boston university</p>
                <div className="icons">
                    <a target="_blank" href="https://www.linkedin.com/in/nicola-c-jackson/"><img id="linkedin-img" width="60" src={LinkedInIcon} /></a>
                ...
                <div className="links">
                    ...
                    <a target="_blank" href="Nicola_Jackson_resume.pdf">
