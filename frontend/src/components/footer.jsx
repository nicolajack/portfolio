    ...
    return (
        <div className="footer">
            <div className="leftIcons">
                <a target="_blank" href="https://www.linkedin.com/in/nicola-jackson-64b22833b/"><img id="footerIcon" width="60" src={LinkedInIcon} /></a>
                <a target="_blank" href="https://github.com/nicolajack"><img id="footerIcon" width="60" src={GithubIcon} /></a>
            </div>
